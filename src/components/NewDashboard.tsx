                ...
                <div id="report-content" className="space-y-12">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-slate-800 text-lg leading-relaxed">
                      Derneğimiz ilgili dönemde <span className="font-bold">{formatCurrency(reportData.monthly.fin.aidat)} TL</span> aidat, <span className="font-bold">{formatCurrency(reportData.monthly.fin.bagis)} TL</span> bağış ve <span className="font-bold">{formatCurrency(reportData.monthly.fin.digerGelir)} TL</span> diğer kalemlerde olmak üzere toplam <span className="font-bold text-blue-700">{formatCurrency(reportData.monthly.fin.tGelir)} TL</span> gelir elde etmiştir. Bu dönemde toplam <span className="font-bold">{reportData.monthly.fin.eKSet.size}</span> kişiye <span className="font-bold">{formatCurrency(reportData.monthly.fin.egitim)} TL</span> eğitim yardımı, <span className="font-bold">{reportData.monthly.fin.sKSet.size}</span> kişiye <span className="font-bold">{formatCurrency(reportData.monthly.fin.sosyal)} TL</span> sosyal yardım ve diğer kalemlerde <span className="font-bold">{formatCurrency(reportData.monthly.fin.digerGider)} TL</span> olmak üzere <span className="font-bold text-rose-700">{formatCurrency(reportData.monthly.fin.tGider)} TL</span> giderde bulunmuştur.
                    </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-slate-800 text-lg leading-relaxed">
                      Yıl başından rapor tarihine kadar <span className="font-bold">{formatCurrency(reportData.yearly.fin.aidat)} TL</span> aidat, <span className="font-bold">{formatCurrency(reportData.yearly.fin.bagis)} TL</span> bağış ve <span className="font-bold">{formatCurrency(reportData.yearly.fin.digerGelir)} TL</span> diğer kalemlerde olmak üzere toplam <span className="font-bold text-emerald-700">{formatCurrency(reportData.yearly.fin.tGelir)} TL</span> gelir elde etmiştir. Bu dönemde toplam <span className="font-bold">{reportData.yearly.fin.eKSet.size}</span> kişiye <span className="font-bold">{formatCurrency(reportData.yearly.fin.egitim)} TL</span> eğitim yardımı, <span className="font-bold">{reportData.yearly.fin.sKSet.size}</span> kişiye <span className="font-bold">{formatCurrency(reportData.yearly.fin.sosyal)} TL</span> sosyal yardım ve diğer kalemlerde <span className="font-bold">{formatCurrency(reportData.yearly.fin.digerGider)} TL</span> olmak üzere <span className="font-bold text-rose-700">{formatCurrency(reportData.yearly.fin.tGider)} TL</span> giderde bulunmuştur.
                    </p>
                    <p className="text-slate-800 text-lg">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-slate-800 text-lg leading-relaxed">
                      Derneğimiz kuruluşundan bugüne kadar <span className="font-bold">{formatCurrency(reportData.allTime.fin.aidat)} TL</span> aidat, <span className="font-bold">{formatCurrency(reportData.allTime.fin.bagis)} TL</span> bağış ve <span className="font-bold">{formatCurrency(reportData.allTime.fin.digerGelir)} TL</span> diğer kalemlerde olmak üzere toplam <span className="font-bold text-blue-800">{formatCurrency(reportData.allTime.fin.tGelir)} TL</span> gelir elde etmiştir. Bu dönemde toplam <span className="font-bold">{reportData.allTime.fin.eKSet.size}</span> kişiye <span className="font-bold">{formatCurrency(reportData.allTime.fin.egitim)} TL</span> eğitim yardımı, <span className="font-bold">{reportData.allTime.fin.sKSet.size}</span> kişiye <span className="font-bold">{formatCurrency(reportData.allTime.fin.sosyal)} TL</span> sosyal yardım ve diğer kalemlerde <span className="font-bold">{formatCurrency(reportData.allTime.fin.digerGider)} TL</span> olmak üzere <span className="font-bold text-rose-700">{formatCurrency(reportData.allTime.fin.tGider)} TL</span> giderde bulunmuştur.
                    </p>
                    <p className="text-slate-800 text-lg">
